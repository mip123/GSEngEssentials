...
public class Company {
    ...
    public void setSymbol(String symb) { this.symbol = symb; }
    ...
    public void setHeadquartersCity(String hqCity) { this.headquartersCity = hqCity; }

    public String getHeadquartersStateOrCountry() { return headquartersStateOrCountry; }

    public void setHeadquartersStateOrCountry(String hqStateOrCountry) { this.headquartersStateOrCountry = hqStateOrCountry; }

    public int getNumberOfEmployees() { return numberOfEmployees; }

    public void setNumberOfEmployees(int numEmployees) { this.numberOfEmployees = numEmployees; }
